...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-[9999] bg-[#050505] transition-all duration-700 flex flex-col items-center justify-center ${isMobileMenuOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible -translate-y-full'
          }`}
      >
