      ...
      <div className="relative z-10 w-full max-w-md p-1 bg-gradient-to-b from-white/10 to-transparent">
        <div className="bg-[#0a0a0a] border border-white/5 p-12 shadow-2xl relative">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-[10px] uppercase tracking-[0.25em] text-gray-500 mt-4 font-medium">
              {accessType === 'dataroom'
          ...
          <div className="mt-12 pt-8 border-t border-white/5 flex flex-col gap-3 opacity-60">
            ...
            <div className="flex items-center gap-2">
              <svg className="w-3.5 h-3.5 text-oldgold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
              <span className="text-[9px] uppercase tracking-widest text-gray-500">TLS 1.3 · IP-logged · 15-min timeout</span>
            </div>
          </div>
