...
Third, wealth mobility depends on the perimeter of enforceability. The wider the perimeter, the cheaper the capital. Sovereign-grade enforceability produces sovereign-grade pricing. Private equity firms often underestimate this. Private credit funds do not. This is why private credit is now the silent engine behind Fund-III acceleration. Credit funds price mobility above all. If collateral can move, rates drop. If collateral is locked, rates spike.
...
Capital raising dynamics have shifted. LP committees no longer evaluate deal pipelines first. They evaluate collateral architecture first. They ask: How fast can you move the asset? How enforceable is the pledge across borders? How quickly can you re‑margin the structure when the macro cycle shifts? How many jurisdictions can you activate without redrafting the entire capital stack? If these answers are soft, capital closes slowly. If these answers are sharp, capital closes immediately.
...
Institutional LPs no longer seek diversification. They seek insulation. They seek acceleration. They seek permanent structures that can withstand political cycles, regulatory changes, tax reforms, and macro volatility. Borderless collateral provides this insulation. It provides this acceleration. It provides the architecture for intergenerational capital transfer at institutional scale.
