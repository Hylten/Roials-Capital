...
THE REGIME SHIFT Capital inefficiency now defines the upper end of the private markets. Sovereign regulators apply increasingly restrictive outbound capital frameworks. Banks operate under Basel-driven risk weightings that severely limit the treatment of non-traditional assets. Private credit has grown into a 2. 1 trillion dollar sector not because it provides more aggressive risk, but because it supplies the speed and structural sophistication that banking systems can no longer offer. Three forces define the current M&A regime:
